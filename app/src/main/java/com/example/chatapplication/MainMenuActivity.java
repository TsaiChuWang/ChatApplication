...
//                    }
    ...
    public void video_imageButton_imageButton_onclick(View view) {
        Intent intent=new Intent(MainMenuActivity.this,Video_Activity.class);
        startActivity(intent);
    }

    public void shop_imageButton_onclick(View view) {
        Intent intent=new Intent(MainMenuActivity.this,Group_Buy_List_Item_Activity.class);
        startActivity(intent);
    }
}